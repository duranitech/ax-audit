...
- Use [GitHub Security Advisories](https://github.com/lucioduran/ax-audit/security/advisories/new) to report privately, or
- email **email@lucioduran.com** with the details.
